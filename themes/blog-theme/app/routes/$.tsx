...
function ArticlePageAndNavigationInternal({
  ...
  return (
    <>
      {/* blog-theme: non-dismissible site header part, rendered above the navbar. */}
      <SiteHeader content={projectParts?.header?.mdast} />
      <TabStateProvider>
...
export default function Page() {
  ...
  const { hide_toc, hide_search, hide_footer_links, hide_navbar } = {
    ...siteDesign,
    ...pageDesign,
  } as TemplateOptions & { hide_navbar?: boolean };
  return (
